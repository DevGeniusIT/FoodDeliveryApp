...
class FoodPageBody extends StatefulWidget {
  const FoodPageBody({Key? key, required this.isSearch}) : super(key: key);
  final bool isSearch;
  @override
...
class _FoodPageBodyState extends State<FoodPageBody> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        //slider section
     !widget.isSearch  ?  GetBuilder<PopularProductController>(builder: (popularProducts){
     ...
     !widget.isSearch  ?    GetBuilder<PopularProductController>(builder: (popularProducts){
        ...
        //popular text
    !widget.isSearch  ?      SizedBox(height: Dimensions.height30)  :Container(),
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  DescriptionText(text:recommendedProduct.recommendedProductList[index].description!),
                                  SizedBox(height: Dimensions.height10,),
                                  Row(
